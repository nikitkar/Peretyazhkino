                                ...
                                <div class="numbersBlockWrapper">
                                    <ul class="numbersBlockList">
                                        <li class="numbersBlockItem">
                                            ...
                                            <p
                                                class="numbersBlockItem--Content"
                                            >
                                                лет лидер рынка
                                            </p>
                                        </li>
            ...
            <section class="breadCrumbs">
                <div class="container">
                    <div class="breadCrumbsWrapper">
                        ...
                        <a
                            class="breadCrumbs--text breadCrumbs--text--active"
                            href="<?php $_SERVER['DOCUMENT_ROOT']?>/about.php"
                            >О нас</a
                        >
                    </div>
                </div>
                        ...
                        <div class="italyMain">
                            ...
                            <div class="italyList">
                                ...
                                <div class="italyListImg">
                                    <img
                                        src="./assets/images/about/backList.png"
                                        alt=""
                                        class="italyListImg--img"
                                    />
                                </div>
                            </div>
                        </div>
