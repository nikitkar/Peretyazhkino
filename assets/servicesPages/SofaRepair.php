...
<body>
    ...
    <main class="main">
        <section class="mainTitle" style="background-image: url(../images/servicesPageBDMainScreen/SofaRepair.jpg);">
            <div class="container">
        ...
        <section class="breadCrumbs">
            <div class="container">
                <div class="breadCrumbsWrapper">
                    ...
                    <a class="breadCrumbs--text breadCrumbs--text--active" href="<?php $_SERVER['DOCUMENT_ROOT'] . "/assets/servicesPages/SofaRepair.php" ?>">Ремонт диванов</a>
                </div>
            </div>
        </section>
                ...
                <div class="InfoWrapper">
                    <div class="InfoLeft">
                        <p class="InfoLeft--text">
                            Компания «Перетяжкино» производит ремонт в мастерской. Обслуживаем все виды диванов. Гарантия 1 год, делаем страховку мебели на время ремонта. Используем материалы от ведущих поставщиков России и Европы.
                        </p>
                                ...
                                <ul class="InfoLeftListContent">
                                    <li class="InfoLeftItemContent">
                                        <p class="InfoLeftItemContent__Title">
                                            ремонт каркаса и механизма трансформации;
                                        </p>
                                    </li>
                                    <li class="InfoLeftItemContent">
                                        <p class="InfoLeftItemContent__Title">
                                            покраску и лакировку, либо замену деревянных элементов;
                                        </p>
                                    </li>
                                    <li class="InfoLeftItemContent">
                                        <p class="InfoLeftItemContent__Title">
                                            перетяжку обивки и замену наполнителя;
                                        </p>
                                    </li>
                                    <li class="InfoLeftItemContent">
                                        <p class="InfoLeftItemContent__Title">
