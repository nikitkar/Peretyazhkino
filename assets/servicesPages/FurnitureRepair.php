...
<body>
    ...
    <main class="main">
        <section class="mainTitle" style="
                        background-image: url(../images/servicesPageBDMainScreen/FurnitureRepair.jpg);
                    ">
            <div class="container">
                <div class="mainTitleWrapper">
                    <div class="mainTitleInfo">
                        <h1 class="mainTitleInfo--title">Ремонт мебели</h1>
        ...
        <section class="breadCrumbs">
            <div class="container">
                <div class="breadCrumbsWrapper">
                    ...
                    <a class="breadCrumbs--text breadCrumbs--text--active" href="<?php $_SERVER['DOCUMENT_ROOT'] . "/assets/servicesPages/FurnitureRepair.php" ?>">Ремонт мебели</a>
                </div>
            </div>
        </section>
                ...
                <div class="InfoWrapper">
                    <div class="InfoLeft">
                        <p class="InfoLeft--text">
                            Реставратор аккуратно разобрал и переклеил
                            каркас, выполнил реставрацию наполнения мягкой
                            мебели, перевязав пружины и настил. После чего
                            отреставрировал ЛКП и перетянул тканью.
                        </p>
                        <div class="InfoLeftInfo">
                            <div class="InfoLeftTitle">
                                ...
                                <h3 class="InfoLeftTitle--title3">
                                    Заказывая ремонт мебели в нашей
                                    мастерской<span>,</span> вы получаете
                                    ряд преимуществ и увеличиваете срок
                                    дальнейшей эксплуатации дивана:
                                </h3>
                            </div>
                                ...
                                <ul class="InfoLeftListContent">
                                    <li class="InfoLeftItemContent">
                                        <p class="InfoLeftItemContent__Title">
                                            ...
                                            цена-качество (смотрите отзывы о
                                            нас);
                                        </p>
                                    </li>
                                    <li class="InfoLeftItemContent">
                                        <p class="InfoLeftItemContent__Title">
                                            Краткие сроки ремонта;
                                        </p>
                                    </li>
                                    <li class="InfoLeftItemContent">
                                        <p class="InfoLeftItemContent__Title">
